...
namespace Application.Mobile.Jellyfish.Controls
{
...

    {
        ...
        {
            return await Application.Current.MainPage.DisplayPromptAsync(title, message, accept, cancel, placeHolder, maxLen, keyboard, initValue);
        }
