...
namespace Application.Mobile.Jellyfish.ViewModel
{
    public class LoginPageViewModel : BaseViewModel
    {
        ...
        private async void SubmitAction()
        {
            ...
            _applicationConfigHandler.ApplicationConfig.AccountConfig.UserSession = new Application.Shared.Kernel.Application.Model.Database.MySQL.Application.Mobile.Jellyfish.AuthModel(response);
            _applicationConfigHandler.Safe();
            LoggedIn();
        }
