...
using Application.Mobile.Jellyfish.Data.AppConfig.Ui;
...
namespace Application.Mobile.Jellyfish.ViewModel.SettingsSubPage
{
        ...
        where T : AbstractApplicationConfig, new()
    {
        ...
        public ObservableCollection<ApplicationConfigPropertyDescriptorViewModel> GetInstanceValuesWithUiDisplayNames(Application.Mobile.Jellyfish.Validation.ValidatableObject.ChangedData changedData)
        {
