...
namespace Application.Web.Api.JellyFishBackend.Controller
{
    ...
    public class UserController : AbstractController<UserModel>
    {
        ...
        public UserController(ILogger<CustomApiControllerBase<UserModel>> logger, IScopedVulnerablityHandler vulnerablityHandler, IMailHandler mailHandler, IAuthHandler authHandler, IScopedDatabaseHandler databaseHandler, IJsonApiDataHandler jsonApiHandler, ITaskSchedulerBackgroundServiceQueuer queue, IScopedJsonHandler jsonHandler, ICachingHandler cache, IActionDescriptorCollectionProvider actionDescriptorCollectionProvider, IWebHostEnvironment env, IConfiguration configuration, IRabbitMqHandler rabbitMqHandler, IAppconfig appConfig, INodeManagerHandler nodeManagerHandler, IScopedEncryptionHandler scopedEncryptionHandler, Application.Shared.Kernel.Application.Controller.Modules.IAbstractBackendModule<UserModel> abstractBackendModule, IServiceProvider serviceProvider, IHubContext<MessengerHub, IMessengerClient> messengerHub) : 
        ...
        public async Task<ObjectResult> UserPasswordResetRequest([FromBody][ModelBinder(typeof(ApiRootNodeModelModelBinder<PasswordResetDataTransferModel>))] PasswordResetRequestDataTransferModel passwordResetDataTransferModel)
        {
