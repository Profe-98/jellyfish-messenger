...
namespace JellyFish.ViewModel
{
    public class RegisterContentPageViewModel : BaseViewModel
    {
        ...
        private async void ActivateAccountAction()
        {
            ...
            var responseFromActivation = await _webApiRestClient.Activate(ActivationToken, new UserActivationDataTransferModel { ActivationCode = (FullActivationCode) }, _webApiActionCancelationToken.Token);
